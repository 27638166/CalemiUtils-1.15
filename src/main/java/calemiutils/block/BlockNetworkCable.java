...
public class BlockNetworkCable extends BlockNetworkCableOpaque {
    ...
    private static final VoxelShape CORE_AABB = Block.makeCuboidShape(5, 5, 5, 11, 11, 11);
    private static final VoxelShape DOWN_AABB = Block.makeCuboidShape(5, 0, 5, 11, 11, 11);
    private static final VoxelShape UP_AABB = Block.makeCuboidShape(5, 5, 5, 11, 16, 11);
    private static final VoxelShape NORTH_AABB = Block.makeCuboidShape(5, 5, 0, 11, 11, 5);
    private static final VoxelShape EAST_AABB = Block.makeCuboidShape(5, 5, 5, 16, 11, 11);
    private static final VoxelShape SOUTH_AABB = Block.makeCuboidShape(5, 5, 5, 11, 11, 16);
    private static final VoxelShape WEST_AABB = Block.makeCuboidShape(0, 5, 5, 11, 11, 11);
    private static final VoxelShape DOWNUP_AABB = Block.makeCuboidShape(5, 0, 5, 11, 16, 11);
    private static final VoxelShape NORTHSOUTH_AABB = Block.makeCuboidShape(5, 5, 0, 11, 11, 16);
    ...
    private boolean canCableConnectTo (IBlockReader world, BlockPos pos, Direction facing) {
        ...
        return block.canBeConnectedTo(world.getBlockState(otherPos), world, otherPos, facing.getOpposite()) || canBeConnectedTo(world.getBlockState(otherPos), world, otherPos, facing.getOpposite());
    }
