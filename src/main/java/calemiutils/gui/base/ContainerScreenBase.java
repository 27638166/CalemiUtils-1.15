...
public abstract class ContainerScreenBase<T extends ContainerBase> extends ContainerScreen<Container> {
    ...
    protected void drawGuiContainerBackgroundLayer (float f, int mouseX, int mouseY) {
        ...
        ScreenHelper.drawCenteredString(name, getScreenX() + getGuiSizeX() / 2, getScreenY() + 6, 5, TEXT_COLOR_GRAY);
    }
    ...
    private void addGraphicsAfterRendering (int mouseX, int mouseY) {
        ...
        if (minecraft != null && getTileEntity() != null) {
            ...
            if (tileEntity instanceof ICurrencyNetworkBank) {
                ...
                GL11.glColor3f(1, 1, 1);
                addCurrencyTab(mouseX, mouseY, tileEntityBank.getStoredCurrency(), tileEntityBank.getMaxCurrency());
            }
            ...
            if (tileEntity instanceof IProgress) {
                ...
                GL11.glColor3f(1, 1, 1);
                addProgressHoveringText(mouseX, mouseY, currentProgress, tileEntityProgress.getMaxProgress());
            }
        }
    }
     ...
     */
    private void addProgressHoveringText (int mouseX, int mouseY, int progress, int maxProgress) {
     ...
     */
    protected void addCurrencyTab (int mouseX, int mouseY, int currency, int maxCurrency) {
     ...
     */
    private void addLeftInfoTab (String text, int sizeY) {
        ...
        if (minecraft != null) {
            ...
            if (!text.isEmpty()) {
                ...
                minecraft.fontRenderer.drawString(text, getScreenX() - width + 4, getScreenY() + (float) (sizeY / 2) - 3 + leftTabOffset, TEXT_COLOR_GRAY);
                GL11.glColor3f(1, 1, 1);
                GL11.glPopMatrix();
            }
     ...
     */
    protected void addRightInfoTab (String text, int sizeAdd, int sizeY) {
        ...
        if (minecraft != null) {
            ...
            if (!text.isEmpty()) {
                ...
                GL11.glTranslatef(0, 0, 5);
                GL11.glColor3f(0.35F, 0.35F, 0.35F);
                minecraft.fontRenderer.drawString(text, getScreenX() + getGuiSizeX() + 4, getScreenY() + (float) (sizeY / 2) - 3 + rightTabOffset, TEXT_COLOR_GRAY);
                GL11.glColor3f(1, 1, 1);
                GL11.glPopMatrix();
            }
