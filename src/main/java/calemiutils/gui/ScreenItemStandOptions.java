...
public class ScreenItemStandOptions extends GuiScreenBase {
    ...
    public void drawGuiBackground (int mouseX, int mouseY) {
        ...
        ScreenHelper.drawCenteredString("Translation", getScreenX() - 70, getScreenY() - 36, 0, 0xFFFFFF);
        ScreenHelper.drawCenteredString("Scale", getScreenX() + 70, getScreenY() - 36, 0, 0xFFFFFF);
        ScreenHelper.drawCenteredString("Rotation", getScreenX() - 70, getScreenY() + 4, 0, 0xFFFFFF);
        ScreenHelper.drawCenteredString("Spin", getScreenX() + 70, getScreenY() + 4, 0, 0xFFFFFF);
        ScreenHelper.drawCenteredString("Pivot", getScreenX(), getScreenY() + 44, 0, 0xFFFFFF);
    }
