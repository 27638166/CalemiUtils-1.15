...
public class WorldEditHelper {
    ...
    public static void generateCommand(ArrayList<Location> list, IForgeBlockState block, Block mask, boolean isAirMask, PlayerEntity player, UnitChatMessage message) {
